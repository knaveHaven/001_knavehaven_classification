...
Changed 030 GAMEDEV to 030 MULTIMEDIA PRODUCTION since there is a huge overlap in it


### 10.06.20

Changing the naming and organization conventions for the PEROGATIVE schedules (A00 D00 C00) to be more verb based, like the william horton instructional objectives they were inspired by.
...
- 00X LIBRARY
- 010 INSTRUCTIONAL DESIGN  
- 020 NEW MEDIA STUDIES  
- 030 MULTIMEDIA DEV  
- 040 COMPUTER SCIENCE  
- 050 ORGANIZATIONS  
- 060 HUMAN COMPUTER INTERACTION  
- 070 GAMES  
...
(connect with crafts, writing, multimedia prod etc)
...
- C01 INSTRUCT (LEARNING OBJECTS)
- C10 WRITE (PROSE)     
- C20 ANALYZE (MEDIA)  
- C30 ORIGINATE (CONTINUITY)   
- C40 CONSULT (INFORMATION SYSTEMS)    
- C50 SEW (CLOTHES)   
- C60 PERFORM (ART)
- C70 DRAW (GRAPHICS)     
- C80 INVENT (REALIA)     
- C90 CODE (APPLICATIONS)
- CA0 DEVELOP (GAMES)  
- CD0 BLOG (CONCIOUSNESS)  
- CC0 COURSE (AUTODIDACTISM)  
...
- 003 ARCHIVING
- 00A LIBRARY SCIENCE READINGS  
- 00C LIBRARY SCIENCE COURSES  
...
- 023 SOCIAL BOOKMARKING
- 024 [VACANT]  
- 025 YOUTUBE RECCOMENDATION ALGORITHM
- 026 CYBERNETICS
- 027 [VACANT]
- 028 VR/AR  
...
- 065 ACCESIBILITY
- 066 ERGONOMICS
- 068 INFORMATION ARCHITECTURE  
- 06C HCI COURSES


- 070 GAMES  
- 071 ALTERNATE REALITY GAMES
- 072 GAMES AND LEARNING  
- 073 CATHARSIS IN GAMES  
- 074 [VACANT] (?) SYSTEMS    
- 075 GAME CULTURE  
- 076 [VACANT]
- (?) GAMES AS ART??? CHANGING THE MEDIUM??
- 078 PLATFORMING
- 079 PLATFORM STUDIES  
...
- 70_ - THEORY (PROCESSES,MEDIUM, AESTHETICS )  
  - 705 - DIY
- 710 - CONCEPTUAL
- 720 - MUSIC  
- 730 - VISUAL  
...
- A20 - READING   
  - A23 - FICTION  
  - A24 - ARTICLES  
  - A25 - ACADEMIC (published books, as well as manifestos)    
- A30 - COMIC  
- A40 - TV  
...
D - DO  ( INTERACT WITH DO, ACTIVITY QUEUE)   
